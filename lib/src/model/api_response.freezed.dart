...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int statusCode, String message, dynamic body});
}
...
class _$_ApiResponse implements _ApiResponse {
  const _$_ApiResponse(
      {required this.statusCode, required this.message, required this.body});
  ...
  @override
  String toString() {
    return 'ApiResponse(statusCode: $statusCode, message: $message, body: $body)';
  }
...
abstract class _ApiResponse implements ApiResponse {
  const factory _ApiResponse(
      ...
      required final dynamic body}) = _$_ApiResponse;
